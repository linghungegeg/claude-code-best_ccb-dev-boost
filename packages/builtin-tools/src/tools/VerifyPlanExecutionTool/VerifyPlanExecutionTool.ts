...
- Include concrete verification notes, preferring the smallest relevant test,
  typecheck, lint, syntax check, or startup check that applies to the changed area
