...
async function postBuild() {
  ...
  if (existsSync('src/utils/vendor/codebase-memory')) {
    ...
    console.log(
      `Copied src/utils/vendor/codebase-memory/ → ${codebaseMemoryDir}/`,
    )
  } else {
    console.log(
      'Skipped codebase-memory vendor copy; use CODEBASE_MEMORY_MCP_COMMAND or install codebase-memory-mcp on PATH.',
    )
  }
