...
import {
  stabilizeMCPDescription,
  stabilizeInputSchema,
} from '../../utils/mcpStabilize.js'
import {
  ClaudeAuthProvider,
      ...
      return toolsToProcess
        .map((tool): Tool => {
          ...
          return {
            ...
            async description() {
              return stabilizeMCPDescription(tool.description ?? '')
            },
            async prompt() {
              const desc = stabilizeMCPDescription(tool.description ?? '')
            ...
            inputJSONSchema: stabilizeInputSchema(
              tool.inputSchema,
