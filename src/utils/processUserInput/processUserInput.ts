...
export async function processUserInput({
  ...
  // Placeholder display is now the caller's responsibility — REPL.tsx onSubmit
  // (direct submit) and handlePromptSubmit queue path (dequeued commands) each
  // call setUserInputOnProcessing before entering the processing pipeline,
  // keeping it in the same React batch as input clearing. This avoids the
  // double-render caused when this function also called it asynchronously.
